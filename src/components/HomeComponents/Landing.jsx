      ...
      <div className="landing-image overflow-hidden w-full h-screen bg-[#592D1E] rounded-[36px] px-8 py-6 flex justify-between relative">
        <div className="landing-text relative">
          {/* <img
            ...
            alt=""
          /> */}
          <div className="text-white font-beach text-[55px] md:text-[70px] lg:text-[110px] md:leading-[120px] relative z-40">MELT YOUR HEARTS</div>
          <div className="w-[45vw] flex flex-col justify-center relative z-20">
            <div className="flex items-center gap-4 w-full my-8">
              ...
              <div className="w-[30%] md:w-[50%] text-white font-beach text-[60px] md:text-[110px] md:leading-[100px]">WITH</div>
            </div>
          </div>
          <div className="text-white font-jagret text-[64px] md:text-[70px] lg:text-[110px] md:leading-[180px] relative z-40">EVERY BITE</div>
          <img
