  ...
  return (
    <div className='section5 w-full pt-10 px-5 bg-[#f5f5f5]'>
        ...
        <div className='threeEggs w-[60%] flex flex-col items-center gap-7 pl-8 py-6'>
            ...
            <p className='section5-para px-24  text-center text-lg'>We take pride in using only the <span className='text-[#592d1e] font-semibold'>finest, locally sourced</span> ingredients to ensure that each loaf, pastry, and treat that leaves our ovens is a masterpiece.</p>
            <div className='w-[50%]'>
